...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="/" class="navbar-logo">BioBasics</a>
        <div class="navbar-search">
            <input type="text" class="search-input" placeholder="Search articles..." style="padding-left: 15px;">
        </div>
        <div class="navbar-actions">
            <div class="nav-streak-indicator">
                <svg class="nav-streak-icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button class="account-btn">JD</button>
        </div>
    </nav>
...
def main():
    ...
    input_path = r"json_demo.json"  # Path to your course JSON file
    output_path = r"demo.html"  # Where to save the generated HTML
