...
CREATE TABLE user_article_comment (
    ...
    user_id UNIQUEIDENTIFIER NOT NULL,
    article_id UNIQUEIDENTIFIER NOT NULL,
    parent_comment_id UNIQUEIDENTIFIER NULL,  -- NULL = top-level comment, otherwise = reply
...
-- User comment votes (likes/dislikes)
CREATE TABLE user_comment_vote (
    user_id UNIQUEIDENTIFIER NOT NULL,
    comment_id UNIQUEIDENTIFIER NOT NULL,
    vote_type NVARCHAR(10) NOT NULL,  -- 'like' or 'dislike'
    created_at DATETIME2 DEFAULT GETDATE(),
